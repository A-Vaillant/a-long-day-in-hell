 ...
 */
export function generateBelief(rng) {
 ...
 */
export function evolveBelief(belief, config = DEFAULT_CRISIS) {
 ...
 */
export function deriveStance(belief, lucidity, hope, direiteExposure, config = DEFAULT_STANCE) {
 ...
 */
export function updateStance(belief, lucidity, hope, direiteExposure, config = DEFAULT_STANCE) {
 ...
 */
export function beliefDecayMod(belief) {
    let hopeMul = 1.0;
    let lucidityMul = 1.0;
 ...
 */
export function entityBeliefDecayMod(world, entity) {
    const belief = getComponent(world, entity, BELIEF);
    if (!belief)
        return { hopeMul: 1.0, lucidityMul: 1.0 };
