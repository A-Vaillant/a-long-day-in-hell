...
import { BELIEF, beliefDecayMod, evolveBelief, updateStance } from "./belief.core.js";
// --- Component keys ---
 ...
 * rate = base * (1 + accel * (1 - stat/100)^curve)
 */
export function decayRate(stat, base, config = DEFAULT_DECAY) {
 ...
 */
export function socialPressureSystem(world, thresholds = DEFAULT_THRESHOLDS, pressureRate = 0.003, awareness = DEFAULT_AWARENESS) {
